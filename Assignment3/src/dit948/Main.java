...
public class Main {
	...
	public static void main(String[] args) {
		...
		assignment = new Assignment(trueVariables);
		...
		System.out.println("I will now check the equivalence fot he following circuits :");
		...
		int number = readInt();
		circuit = Circuit.mkRandom(2, allVariables);
	}
}